...
function Data() {
    ...
    const fetchdataAgri = async () => {
        ...
        const products = await axios.get("https://nibackend.onrender.com/agri");
        setData(products.data);
        setDis(true)
    }

    const fetchdataSoftware = async () => {
        const products = await axios.get("https://nibackend.onrender.com/software");
        setData(products.data);
        setDis(true)
    }
    ...
    const fetchdataAutomobile = async () => {
        ...
        const products = await axios.get("https://nibackend.onrender.com/auto");
        setData(products.data);
        setDis(true)
    }
    ...
    const fetchdataElectrical = async () => {
        ...
        const products = await axios.get("https://nibackend.onrender.com/electrical");
        setData(products.data);
        setDis(true)
    }
    ...
    const fetchdataRecycling = async () => {
        ...
        const products = await axios.get("https://nibackend.onrender.com/recycling");
        setData(products.data);
        setDis(true)
    }
    ...
    const fetchdata = async () => {
        const products = await axios.get("https://nibackend.onrender.com");
        setData(products.data);
        setDis(true)
    }
    useEffect(() => {
